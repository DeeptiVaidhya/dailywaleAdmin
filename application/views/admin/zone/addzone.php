<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Zone</div>
                            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <form action="<?php echo site_url('Zone/addZone');?>" method="post" >
                  <div class="card-body row">
                          ...
                          <div class="col-lg-4 p-t-20"> 
                            <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                 <input class = "mdl-textfield__input" type = "text" id = "zonename" name="zone_name" style="text-transform: capitalize;">
