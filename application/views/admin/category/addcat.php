<!-- start page content -->
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <form action="<?php echo site_url('Category/addcategory');?>" method="post" enctype="multipart/form-data" onsubmit="return validation();" >
                  <div class="card-body row">
                         <!--  <div class="col-lg-6 p-t-20"> 
                          ...
                          <div class="col-lg-6 p-t-20"> 
                            <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                 <input class = "mdl-textfield__input" type = "text" id = "cat_name" name="cat_name" style="text-transform: capitalize;">
