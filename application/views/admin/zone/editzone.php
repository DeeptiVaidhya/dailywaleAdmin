                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Edit Zone details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Edit Zone details</li>
                            </ol>
                        </div>
                    </div>
						<div class="row">
                  ...
                  <?php echo $this->session->flashdata('zone');?>
									<?php 
                  ...
                  <form action="<?php echo site_url('Zone/zoneEdit');?>" method="post" onsubmit="return validation();" enctype="multipart/form-data">

									<div class="card-body row">
                        <div class="col-lg-6 p-t-20"> 
                            <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                 <select class = "mdl-textfield__input" id = "freename" name="city_name" style="text-transform: capitalize;">
                                  <?php 
                                  $zid = $records->city_id;
                                  foreach ($city as $key) { ?>
                                    <option <?php if($key['city_id']==$zid){ echo'selected'; } ?> value="<?php echo $key['city_id'];?>"><?php echo $key['city_name'];?></option>
                                  <?php }
                                  ?>
                                 </select>
                                 <label class = "mdl-textfield__label" >city Name</label>
                                  <span class="intro" id="errorname"></span>
							            ...
							            <div class="col-lg-6 p-t-20">
							             <input class = "mdl-textfield__input" type = "hidden" id = "Name" name="id" value="<?php echo $records->zone_id;?>">
 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" id = "name" name="zone_name" value="<?php echo $records->zone_name;?>" style="text-transform: capitalize;">
