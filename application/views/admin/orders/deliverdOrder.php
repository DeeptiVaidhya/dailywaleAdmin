               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card card-box">
                        <div class="card-head">
                           <header>Show Deliverd Order</header>
                        </div>
                        <div class="card-body ">
                           <div class="row">
                              <div class="card-body ">
...
<script type="text/javascript">
   ...
   function getRecord(){
      ...
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('index.php/Orders/deliverddata');?>/?from="+from+"&to="+to,
         ...
         if(obj.length>0){
            ...
            for(var i=0;i<obj.length;i++){
               ...
               dataTablePending.row.add([
                ...
                order_date,
                driver_name,
                '<a class="btn btn-primary" href="<?php echo site_url('Orders/updateDeliveryOrder/3/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">Return</i></a>'
              ]).draw(true);


               html += '<tr><td>'+cart_id+'</td><td>'+name+' '+lname+'</td><td>'+email+'</td><td>'+mobile+'</td><td>'+address+'</td><td>'+item_name+'</td><td>'+quantity+'</td><td>'+total_amount+'</td><td>'+order_date+'</td><td>'+driver_name+'</td><td><a class="btn btn-primary" href="<?php echo site_url('Orders/updateDeliveryOrder/3/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">Return</i></a><!--<a class="btn btn-basic" href="<?php echo site_url('Orders/pendingview/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">View</i></a>--></td></tr>';
            }
            console.log(html);
