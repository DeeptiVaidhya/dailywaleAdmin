                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Edit State details</div>
                            </div>
                  ...
                  <form action="<?php echo site_url('state/stateEdit');?>" method="post" onsubmit="return validation();" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6 p-t-20"> 
                            <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                 <select class = "mdl-textfield__input" id = "freename" name="country_name" style="text-transform: capitalize;">
                                  <?php 
                                  $cid = $records->country_id;
                                  foreach ($country as $key) { ?>
                                    <option <?php if($key['country_id']==$cid){ echo'selected'; } ?> value="<?php echo $key['country_id'];?>"><?php echo $key['name'];?></option>
                                  <?php }
                                  ?>
                                 </select>
                                 <label class = "mdl-textfield__label" >Country Name</label>
                                  <span class="intro" id="errorname"></span>
							            ...
							            <div class="col-lg-6 p-t-20">
							             <input class = "mdl-textfield__input" type = "hidden" id = "Name" name="id" value="<?php echo $records->state_id;?>">
 
							              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
						                     <input class = "mdl-textfield__input" type = "text" id = "name" name="state_name" value="<?php echo $records->state_name;?>" style="text-transform: capitalize;">
