                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Pop_item</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Pop_item</li>
                            </ol>
                        </div>
                    </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="card-box">
                 ...
                 <?php echo $this->session->flashdata('Popular_item');?>    
                               
                  </div>
                <form action="<?php echo site_url('Popular_item/add_pop_item');?>" method="post" >
