    ...
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                <!-- logo start -->
                <div class="page-logo">
                    <a href="http://dailywale.com/dailywaleAdmin/index.php/Vendor/dashboard">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
 						<li class="dropdown dropdown-user">
                              <?php foreach($vendorDetail as $row){ }?>
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle" src="<?php echo base_url();?>/<?php echo  $row['profile'];?>" />   
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="<?php echo site_url('Vendor/user_profile')?>">
