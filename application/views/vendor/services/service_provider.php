                           ...
                           <div class="row">
                              <div class="col-md-12 col-sm-12 col-12">
                                 <div class="btn-group pull-right">
                                    <a href="<?php echo site_url('Vendor/services_Add');?>" id="addRow" class="btn btn-info">
                              ...
                              <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                                 ...
                                 <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <td>
                                       <a href="<?php echo site_url('Vendor/edit_services/').$row['service_id'];?>"" class="btn btn-primary btn-xs">
                                       <i class="fa fa-pencil"></i>
                                       </a> 
                                       <td>  
                                       <a href="<?php echo site_url('Vendor/deleterecordservices/').$row['service_id'];?>/service_provider/Service_provider" class="btn btn-danger btn-xs" onclick="return conformDelete()">
