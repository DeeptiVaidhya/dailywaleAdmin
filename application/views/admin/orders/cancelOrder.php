               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card card-box">
                        <div class="card-head">
                           <header>Show Cancel Order</header>
                        </div>
                        <div class="card-body ">
                           <div class="row">
                              <div class="card-body ">
...
<script type="text/javascript">
   ...
   function getRecord(){
      ...
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('index.php/Orders/canceldata');?>/?from="+from+"&to="+to,
         ...
         if(obj.length>0){
            ...
            for(var i=0;i<obj.length;i++){
              var name           = obj[i]['fname'];
               ...
               html += '<tr><td>'+j+'</td><td>'+name+' '+lname+'</td><td>'+email+'</td><td>'+mobile+'</td><td>'+address+'</td><td>'+item_name+'</td><td>'+quantity+'</td><td>'+total_amount+'</td><td>'+order_date+'</td><!--<td><a class="btn btn-primary" href="<?php echo site_url('Orders/updateStatus/4/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">Dispatch</i></a><a class="btn btn-danger" href="<?php echo site_url('Orders/updateStatus/2/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">Cancel</i></a><a class="btn btn-basic" href="<?php echo site_url('Orders/pendingview/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">View</i></a></td>--></tr>';
            }
            console.log(html);
