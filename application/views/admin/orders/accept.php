...
<script type="text/javascript">
   ...
   function getRecord(){
      ...
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('index.php/Orders/fetchdata1');?>/?from="+from+"&to="+to,
      success: function(data){
         ...
         if(obj.length>0){
            ...
            for(var i=0;i<obj.length;i++){
               ...
               j = ++j;
              html += '<tr><td>'+j+'</td><td>'+name+'</td><td>'+item_name+'</td><td>'+total_amount+'</td><td>'+order_date+'</td><td><a class="btn btn-danger" href="<?php echo site_url('Orders/updateStatus/3/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">Return</i></a><!--<a class="btn btn-primary" href="<?php echo site_url('Orders/updateStatus/4/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">Dispatch</i></a><a class="btn btn-danger" href="<?php echo site_url('Orders/updateStatus/2/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">Cancel</i></a><a class="btn btn-basic" href="<?php echo site_url('Orders/pendingview/');?>'+cart_id+'"><i class="glyphicon glyphicon-ok">View</i></a>--></td></tr>';
            }
            console.log(html);
