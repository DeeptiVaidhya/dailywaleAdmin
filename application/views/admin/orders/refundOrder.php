               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card card-box">
                        <div class="card-head">
                           <header>Show Refund Order</header>
                        </div>
                        <div class="card-body ">
                           <div class="row">
                              <div class="card-body ">
...
<script type="text/javascript">
   ...
   function getRecord(){
      ...
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('index.php/Orders/refunddata');?>/?from="+from+"&to="+to,
