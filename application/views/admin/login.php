...
<head>
	...
	<!-- favicon -->
    <link rel="shortcut icon" href="http://radixtouch.in/smart/source/assets/img/favicon.icon" /> 
</head>
<body>
    ...
    <div class="login-form text-center">
        ...
        <div class="form formLogin">
            ...
            <form action="<?php echo site_url('welcome/login');?>" method="post" onsubmit="return validation();" name="login" id="login">
