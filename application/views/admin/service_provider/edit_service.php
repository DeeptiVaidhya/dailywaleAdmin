                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Edit Service provider details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Edit Service provider details</li>
                            </ol>
                        </div>
                    </div>
						<div class="row">
                  ...
                  <form action="<?php echo site_url('Service_provider/services_Edit');?>" method="post">
