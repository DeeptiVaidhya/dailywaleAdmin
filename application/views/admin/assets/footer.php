    <!-- start footer -->
        <div class="page-footer">
            <div class="page-footer-inner"> <?php echo date('Y');?> &copy; DailyWale By
            <a href="mailto:redstartheme@gmail.com" target="_top" class="makerCss">Engineermaster</a>
            </div>
