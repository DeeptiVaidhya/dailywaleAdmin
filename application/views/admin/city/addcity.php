<!-- start page content -->
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <form action="<?php echo site_url('City/addCity');?>" method="post" >
                  <div class="card-body row">
                          ...
                          <div class="col-lg-4 p-t-20"> 
                            <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                 <input class = "mdl-textfield__input" type = "text" id = "cityname" name="city_name" style="text-transform: capitalize;">
